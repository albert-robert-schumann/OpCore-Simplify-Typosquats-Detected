...
<p> The official repo is this: https://github.com/lzhoang2801/OpCore-Simplify . My own repo, which is all about security fixes is this: https://github.com/albert-robert-schumann/OpCore-Simplify-FixVulnerabilities and it has fixed vulnerabilities like outdated Google Chrome 131 user agent string. To see more what it has been fixed, read the readme in that repository. Both of these repositories are malware-free</p>
